...
export const handleDeleting = async (post_id: string, post: (ItemApp | ItemCvs)[], updatePosts: UpdatePostsFunction, user: User, dispatch: Dispatch<UnknownAction>, haveToBeUpdated: string) => {
    try {
